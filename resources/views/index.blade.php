...
<body>
        ...
        <div class="container-fluid">
            <nav class="navbar navbar-light bg-light justify-content-between">
                <div id="mySidenav" class="sidenav">
                    ...
                    <a href="/">Home</a>
                    <a href="/computers">Computers&&Laptops</a>
                    <a href="/mobiles">Mobiles&&Watchs&&Cameras</a>
                    <a href="/men">Mans Fashion</a>
                    <a href="/woman">Womans Fashion</a>
                    <a href="/contact">Contact</a>
                </div>
                <span style="font-size:30px;cursor:pointer; color: #fff;" onclick="openNav()"><img
                        src="images/toggle-icon.png"></span>
                <a class="navbar-brand" href="/"><img src="images/logo.png" width=80px></a></a>
                <form class="form-inline ">
                    <div class="login_text">
                        <ul>
                            <li><a href="/profile"><img src="images/user-icon.png"></a></li>
                            <li><a href="/cards"><img src="images/trolly-icon.png"></a></li>
            ...
            <div class="catagary_main">
                ...
                <div class="catagary_right">
                    <div class="catagary_menu">
                        <ul>
                            <li><a href="/men">Man's Fashion</a></li>
                            <li><a href="/woman">Woman Fashion</a></li>
                            <li><a href="/mobiles">Mobiles</a></li>
                            <li><a href="/computers">Computers</a></li>
                            <li><a href="/computers/">Laptops</a></li>
                            <li><a href="/mobiles">Watchs</a></li>
                            <li><a href="/mobiles">Cameras</a></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <!-- mans Fashion section start -->
    <div class="mans_section layout_padding">
        <div class="container">
            <h1 class="computers_taital">Man’s Fashion</h1>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="lorem_text">There are many variations of passages of Lorem Ipsum available,but the
                            majority have</p>
                        <div class="read_bt"><a href="/men">Buy Now</a></div>
                    </div>
                    <div class="col-md-6">
                        <div class="image_3"><img src="images/mens.jpg"></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <!-- mans Fashion section end -->
    <!-- womans Fashion section start -->
    <div class="mans_section layout_padding">
        <div class="container">
            <h1 class="computers_taital">Woman's Fashion</h1>
        </div>
    </div>
    <div class="mans_section_2">
        <div class="container-fluid">
            <div class="mans_main">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="offer_text">Best Offer Every Woman’s Iteams</h1>
                        <p class="lorem_text">There are many variations of passages of Lorem Ipsum available,but the
                            majority have</p>
                        <div class="read_bt"><a href="/woman">Buy Now</a></div>
                    </div>
                    <div class="col-md-6">
                        <div class="image_3"><img src="images/womans.jpg"></div>
                    </div>
                </div>
            </div>
        </div>
    </div>
    <!-- womans Fashion section end -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        ...
                        <div class="footer_menu">
                            <ul>
                                <li><a href="/">Home</a></li>
                                <li><a href="/computers">Computers&&Laptops</a></li>
                                <li><a href="/mobiles">Mobiles&&Watchs&&Cameras</a></li>
                                <li><a href="/men">Mans Clothes</a></li>
                                <li><a href="/woman">Womans Clothes</a></li>
